...
class _Mode0Layout_SI:
    ...
    BEGIN_EYE_DISTANCE  = END_EYE_DIRECTION
    END_EYE_DISTANCE    = BEGIN_EYE_DISTANCE + 1*_SIZEOF.FLOAT
    BEGIN_HAND_LEFT     = END_EYE_DISTANCE
...
class unpack_si:
    ...
    def get_eye_ray(self):
        ...
        distance = np.frombuffer(self._data[_Mode0Layout_SI.BEGIN_EYE_DISTANCE : _Mode0Layout_SI.END_EYE_DISTANCE], dtype=np.float32)

        return _SI_EyeRay(origin, direction, distance)
